...
<head>
    ...
    <!-- description -->
    <meta name="description" content="MegaOne is a highly creative, modern, visually stunning and Bootstrap responsive multipurpose assets and portfolio HTML5 template with 8 ready home page demos.">
    <!-- keywords -->
    <meta name="keywords" content="creative, modern, clean, bootstrap responsive, html5, css3, portfolio, blog, assets, templates, multipurpose, one page, corporate, start-up, studio, branding, designer, freelancer, carousel, parallax, photography, personal, masonry, grid, faq">
    <!-- Page Title -->
    <title>assets | MegaOne HTML5 Template</title>
    <!-- Favicon -->
    ...
    <nav class="navbar navbar-top-default navbar-expand-lg navbar-gradient nav-icon alt-font">
        <div class="container">
            <a class="logo link scroll" href="javascript:void(0)" title="Logo">
                <!--Logo Default-->
                <img alt="logo" class="logo-dark default" src="assets/img/logo-white.png">
            </a>


            <!--Nav Links-->
            <div class="collapse navbar-collapse" id="assets">
    ...
    <div class="nav-holder main style-2 alt-font">
        ...
        <div class="container">
            <div class="shape-left">
                ...
                <img alt="shape" src="assets/img/shape-8.png">
            </div>
            <div class="shape-right">
                ...
                <img alt="shape" src="assets/img/shape-7.png">
            </div>
        </div>
    </div>
...
<section class="p-0 no-transition cursor-light" id="home">
    ...
    <div class="rev_slider_wrapper fullscreen-container" data-alias="megaone-assets-1" data-source="gallery"
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="5" data-xe="0" data-xs="0"
                             data-ye="15" data-ys="-15"><img alt="" data-hh="['87px','87px','87px','87px']"
                                                             data-no-retina
                                                             data-ww="['44px','44px','44px','44px']" src="assets/img/shape-6.png">
                        </div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="Power0.easeIn" data-speed="5" data-xe="0"
                             data-xs="0" data-ye="20" data-ys="0"><img alt="" data-hh="['87px','87px','87px','87px']"
                                                                       ...
                                                                       src="assets/img/shape-5.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-wave" data-angle="0" data-origin="50% 50%" data-radius="15px"
                             data-speed="12"><img alt="" data-hh="['67px','67px','67px','67px']"
                                                        data-no-retina
                                                        data-ww="['68px','68px','68px','68px']" src="assets/img/shape-4.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-rotate" data-easing="Power0.easeIn" data-enddeg="360" data-origin="50% 50%"
                             data-speed="15" data-startdeg="0"><img alt="" data-hh="['69px','69px','69px','69px']"
                                                                        ...
                                                                        src="assets/img/shape-3.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-pendulum" data-easing="" data-enddeg="20" data-origin="50% 50%"
                             data-speed="12" data-startdeg="-20"><img alt="" data-hh="['52px','52px','52px','52px']"
                                                                        ...
                                                                        src="assets/img/shape-1.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="2" data-xe="15" data-xs="0"
                             data-ye="0" data-ys="0"><img alt="" data-hh="['14px','14px','14px','14px']"
                                                          data-no-retina
                                                          data-ww="['50px','50px','50px','50px']" src="assets/img/shape-2.png"></div>
                    </div>
                    ...
                    <div class="tp-caption   tp-resizeme"
                        ...
                        <div class="rs-looped rs-slideloop" data-easing="" data-speed="5" data-xe="15" data-xs="-10"
                             data-ye="0" data-ys="0"><img alt="" data-hh="['604px','510','510','510']"
                                                          data-no-retina
                                                          data-ww="['434px','350','350','350']" src="assets/img/vector-art-1.png"></div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInRight">
                <div class="half-img mt-5 pt-4 mt-lg-0 pt-lg-0">
                    <img alt="vector" src="assets/img/vector-art-2.png">
                </div>
            </div>
        </div>
    </div>
...
<section class="gradient-bg2" id="counters">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInLeft">
                <div class="half-img mt-5 pt-4 mt-lg-0 pt-lg-0">
                    <img alt="vector" src="assets/img/vector-art-3.png">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row wow fadeInUp">
            <div class="col-md-4">
                <div class="team-item">
                    <!--Team Image-->
                    <img alt="image" class="team-image" src="assets/img/team-img1.png">
                    <!--Name-->
                    <div class="name">
                        <img alt="shape" src="assets/img/shape-10.png">
                        <h6>David Joe</h6>
                    </div>
                    <!--Designation-->
            ...
            <div class="col-md-4">
                <div class="team-item">
                    <!--Team Image-->
                    <img alt="image" class="team-image" src="assets/img/team-img2.png">
                    <!--Name-->
                    <div class="name">
                        <img alt="shape" src="assets/img/shape-9.png">
                        <h6>Natalie Roy</h6>
                    </div>
                    <!--Designation-->
                    <p class="designation mb-2">Director</p>
            ...
            <div class="col-md-4">
                <div class="team-item">
                    <!--Team Image-->
                    <img alt="image" class="team-image" src="assets/img/team-img3.png">
                    <!--Name-->
                    <!--Name-->
                    <div class="name">
                        <img alt="shape" src="assets/img/shape-11.png">
                        <h6>Jhon Wok</h6>
                    </div>
                    <!--Designation-->
                    <p class="designation mb-2">Director</p>
...
<section class="bg-light">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 wow fadeInRight">
                <div class="half-img mt-5 pt-4 mt-lg-0 pt-lg-0">
                    <img alt="image" src="assets/img/vector-art-4.png">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="cbp cbp-l-grid-mosaic-flat" id="js-grid-mosaic-flat">
                    ...
                    <div class="cbp-item web-design graphic">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-1.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-1" src="assets/img/work-1.jpg">
                            </div>
                    ...
                    <div class="cbp-item seo marketing">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-2.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-2" src="assets/img/work-2.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item seo marketing">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-3.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-4" src="assets/img/work-3.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item graphic seo marketing">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-4.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-3" src="assets/img/work-4.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item web-design graphic">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-5.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-5" src="assets/img/work-5.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item seo marketing graphic ">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-6.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-6" src="assets/img/work-6.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item web-design seo">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-7.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-7" src="assets/img/work-7.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item web-design graphic">
                        <a class="cbp-caption cbp-lightbox" href="assets/img/work-8.jpg">
                            <div class="cbp-caption-defaultWrap">
                                <img alt="port-8" src="assets/img/work-8.jpg">
                            </div>
                            <div class="cbp-caption-activeWrap"></div>
                            <div class="cbp-l-caption-alignCenter center-block">
                                <div class="cbp-l-caption-body">
...
<section class="bg-light" id="blog">
    <div class="container">
        ...
        <div class="row wow fadeInUp">
            ...
            <div class="col-lg-4">
                <div class="news-item">
                    <img alt="image" class="news-img" src="assets/img/blog-news-1.jpg">
                    <div class="news-text-box">
                        <span class="date main-color">October 29, 2020</span>
                        <a href="assets/blog-list.html"><h4 class="news-title">Web design is fun</h4></a>
                        ...
                        <a class="author d-flex align-items-center" href="javascript:void(0);">
                            <img alt="image" class="author-img bg-blue" src="assets/img/avatar-1.png">
            ...
            <div class="col-lg-4">
                <div class="news-item">
                    <img alt="image" class="news-img" src="assets/img/blog-news-2.jpg">
                    <div class="news-text-box">
                        <span class="date main-color">October 29, 2020</span>
                        <a href="assets/blog-list.html"><h4 class="news-title">Future of websites</h4></a>
                        <p class="para">Lorem ipsum dolor sit amet consectetur adipiscing elit ipsum dolor sit am...</p>
                        <a class="author d-flex align-items-center" href="javascript:void(0);">
                            <img alt="image" class="author-img bg-purple" src="assets/img/avatar-2.png">
            ...
            <div class="col-lg-4">
                <div class="news-item">
                    <img alt="image" class="news-img" src="assets/img/blog-news-3.jpg">
                    <div class="news-text-box">
                        <span class="date main-color">October 29, 2020</span>
                        <a href="javascript:void(0);"><h4 class="news-title">Digital marketing</h4></a>
                        <p class="para">Lorem ipsum dolor sit amet consectetur adipiscing elit ipsum dolor sit am...</p>
                        <a class="author d-flex align-items-center" href="javascript:void(0);">
                            <img alt="image" class="author-img bg-pink" src="assets/img/avatar-5.png">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="owl-carousel partners-slider">
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="assets/img/client-1.png"></div>
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="assets/img/client-2.png"></div>
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="assets/img/client-3.png"></div>
                    <!--Item-->
                    <div class="logo-item"><img alt="client-logo" src="assets/img/client-4.png"></div>
                </div>
            </div>
        </div>
    </div>
